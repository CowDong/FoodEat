...
public class ConstructionHelperOverlay extends Overlay {
    ...
    @Inject
    public ConstructionHelperOverlay(ConstructionHelperPlugin plugin) {
        this.plugin = plugin;

        this.setPriority(OverlayPriority.HIGHEST);
        this.setPosition(OverlayPosition.BOTTOM_LEFT);
        this.getMenuEntries().add(new OverlayMenuEntry(RUNELITE_OVERLAY_CONFIG, OPTION_CONFIGURE, "Construction Helper Overlay"));
    }
