...
public class TaskSet {
    ...
    public void addAll(ConstructionHelperPlugin plugin, Client client, ClientThread clientThread, ConstructionHelperConfig config, List<Class<?>> taskClazzes) {
        for (Class<?> taskClass : taskClazzes) {
            try {
                Constructor ctor = taskClass.getDeclaredConstructor(ConstructionHelperPlugin.class, Client.class, ClientThread.class, ConstructionHelperConfig.class);
