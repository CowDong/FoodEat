...
public class DominicDreamTask extends Task {
    public DominicDreamTask(NMZHelperPlugin plugin, Client client, ClientThread clientThread, NMZHelperConfig config) {
    ...
    public boolean validate() {
        ...
        Widget dialogNpcContinueWidget = client.getWidget(231, 4);
