...
public class WithdrawOverloadTask extends Task {
    public WithdrawOverloadTask(NMZHelperPlugin plugin, Client client, ClientThread clientThread, NMZHelperConfig config) {
    ...
    public boolean validate() {
        ...
        //if we dont have enough overload doses to continue
        if (client.getVarbitValue(3953) + getDoseCount() < config.overloadDoses())
            return false;

        //already have overloads in inventory
